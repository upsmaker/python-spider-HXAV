...
class YzsqSpider(scrapy.Spider):
    name = 'yzsq'
    allowed_domains = ['www.hxsq5.com','template.backgroundimagecache.email']
    start_urls = ['http://www.hxsq5.com/forum-81-1.html']

    baseUrl="http://www.hxsq5.com/"
